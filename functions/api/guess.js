import { json, seoulDateKey, pickDailyAnswer, d1GetByWord, similarityScore, normalizeWord } from './_common.js';
...
export async function onRequestGet({ request, env }){
  try{
    ...
    if (!isCorrect && percent >= 100) percent = 99; // 오답인데 100% 나오는 경우 방지
